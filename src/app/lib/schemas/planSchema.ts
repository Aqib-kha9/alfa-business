...
export const planSchema = z.object({
  ...
  monthlyPrice: z.number().positive({ message: "Monthly price must be a positive number" }),
  yearlyPrice: z.number().positive({ message: "Yearly price must be a positive number" }),
